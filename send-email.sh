...
'    
    ...
    declare -r mailBodyToEncrypt=$($MIME_CONSTRUCT --output --type 'text/plain; charset="utf-8"' --file <(translateTemplate "${keyId}" "${signeeUid}" "${signerName}") --type "application/pgp-keys" --attachment "$keyFile" --file $keyFile) 
